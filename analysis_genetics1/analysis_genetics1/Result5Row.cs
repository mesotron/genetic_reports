...
namespace analysis_genetics1
{
    internal class Result5Row
    {
        ...
        public string Scheuner14Value { get; set; }
        public string Scheuner15Value { get; set; }
        public string Scheuner16Value { get; set; }
        public string Scheuner17Value { get; set; }
        public string Scheuner18Value { get; set; }
        public string ResultUnderstoodValue { get; set; }
        public string AdultsInHouseValue { get; set; }
        public string ChildrenInHouseValue { get; set; }
        public string StatusSliderIsNearlyCorrect { get; set; }
        public string ChildSliderIsNearlyCorrect { get; set; }
        public string OcScore1 { get; set; }
        public string OcScore2 { get; set; }
        public string CommunicationEfficacy { get; set; }
        public string SubjectiveNumeracy { get; set; }
        public string StatusBeforeChild { get; set; }
        public string StatusBeforeCompare { get; set; }
        public string ChildBeforeCompare { get; set; }


        public Result5Row(char delimiter, string line)
        {
            ...
            this.StatusIsNearlyCorrect = toks[178];
            this.ChildIsNearlyCorrect = toks[179];
            this.Hard1000IsNearlyCorrect = toks[180];
            this.Hard800IsNearlyCorrect = toks[181];
            this.Scheuner14Value = toks[182];
            this.Scheuner15Value = toks[183];
            this.Scheuner16Value = toks[184];
            this.Scheuner17Value = toks[185];
            this.Scheuner18Value = toks[186];
            this.ResultUnderstoodValue = toks[187];
            this.AdultsInHouseValue = toks[188];
            this.ChildrenInHouseValue = toks[189];
            this.StatusSliderIsNearlyCorrect = toks[190];
            this.ChildSliderIsNearlyCorrect = toks[191];
            this.OcScore1 = toks[192];
            this.OcScore2 = toks[193];
            this.CommunicationEfficacy = toks[194];
            this.SubjectiveNumeracy = toks[195];
            this.StatusBeforeChild = toks[196];
            this.StatusBeforeCompare = toks[197];
            this.ChildBeforeCompare = toks[198];
        }
    }
}
